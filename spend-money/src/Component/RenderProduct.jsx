...
function RenderProduct() {
        ...
        setListProduct(prevList => {
            const updatedList = prevList.map(product => {
              if (product.id === id ) {
                return {
                  ...product,
                  quantity: operation === "increase" ? product.quantity + 1 : product.quantity - 1
                };
              }
              return product;
            });
    ...
    // const newPrice = listProduct.reduce((id, product) => {
    //     return id + product.price * product.quantity;
    //   }, 0);
    //   setPrice(newPrice);
  ...
  return (
    <div>
        <div className="navbar-content">
          <div>To Spend: <strong>$128,000,000,000 </strong>  </div>
        ...
        {listProduct.map((product) => (
         ...
         <div className="InterestandAdd">
           <button class="btn-Interest" 
            onClick={() => handleQuantity(product.id, "decrease")} disabled={product.quantity === 0}>
             Interest
           </button>
           <span id="amount">{product.quantity}</span>
